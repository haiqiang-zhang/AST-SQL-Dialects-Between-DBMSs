...
INSERT INTO t_latin1 VALUES (_latin1'ÃÂÃÂÃÂÃÂ');
CREATE TABLE t_utf8(c CHAR(40)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
INSERT INTO t_utf8 VALUES ('aaa'), ('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ');
CREATE TABLE t_koi8r (c1 VARBINARY(255), c2 VARBINARY(255));
INSERT INTO t_koi8r (c1, c2) VALUES ('ÃÂÃÂ®ÃÂÃÂ, ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ','ÃÂÃÂ®ÃÂÃÂ, ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ');
