...
DROP TABLE t0;
CREATE PROCEDURE p() BEGIN of: LOOP LEAVE of;
CREATE PROCEDURE p1() BEGIN skip: LOOP LEAVE skip;
CREATE PROCEDURE p2() BEGIN locked: LOOP LEAVE locked;
CREATE PROCEDURE p3() BEGIN nowait: LOOP LEAVE nowait;
