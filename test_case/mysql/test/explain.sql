...
insert into t1 values(1);
drop table t1;
create table ÃÂÃÂÃÂ (ÃÂÃÂÃÂ0 int, ÃÂÃÂÃÂ1 int, key ÃÂÃÂÃÂ0 (ÃÂÃÂÃÂ0), key ÃÂÃÂÃÂ01 (ÃÂÃÂÃÂ0,ÃÂÃÂÃÂ1));
insert into ÃÂÃÂÃÂ (ÃÂÃÂÃÂ0) values (1);
insert into ÃÂÃÂÃÂ (ÃÂÃÂÃÂ0) values (2);
drop table ÃÂÃÂÃÂ;
select 3 into @v1;
