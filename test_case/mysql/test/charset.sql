...
SELECT 'x' AS 'ÃÂ°ÃÂÃÂÃÂ¬';
SELECT 'ÃÂ°ÃÂÃÂÃÂ¬';
CREATE TABLE ÃÂ°ÃÂÃÂÃÂ¬(a INT);
CREATE TABLE t2(a INT COMMENT "ÃÂ°ÃÂÃÂÃÂ¬");
CREATE TABLE t3(a INT);
CREATE VIEW v1 AS SELECT 'x' AS'ÃÂ°ÃÂÃÂÃÂ¬';
DROP TABLE ÃÂ°ÃÂÃÂÃÂ¬;
DROP TABLE t1, t2, t3;
PREPARE stmt FROM "SELECT 'x' AS 'ÃÂ°ÃÂÃÂÃÂ¬'";
SELECT 'x' AS 'ÃÂ°ÃÂÃÂÃÂ¬';
SELECT 'ÃÂ°ÃÂÃÂÃÂ¬';
CREATE TABLE ÃÂ°ÃÂÃÂÃÂ¬(a INT);
CREATE TABLE t1(ÃÂ°ÃÂÃÂÃÂ¬ INT);
CREATE TABLE t2(a INT COMMENT "ÃÂ°ÃÂÃÂÃÂ¬");
CREATE TABLE t3(a INT);
DROP TABLE t3;
PREPARE stmt FROM "SELECT 'x' AS 'ÃÂ°ÃÂÃÂÃÂ¬'";
