...
DROP TABLE t1;
SELECT * FROM (SELECT 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¥' AS x) AS dt WHERE x = 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¥';
CREATE TABLE t1 (f1 VARCHAR(10));
SELECT * FROM (SELECT f1 FROM t1 UNION SELECT f1 FROM t1) AS dt WHERE f1 = 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¥';
DROP TABLE t1;
CREATE TABLE t1 (f1 INTEGER);
SELECT f1
FROM t1 JOIN
