...
DROP PROCEDURE p1;
CREATE PROCEDURE p2() COMMENT 'testÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ' SELECT 1;
ALTER PROCEDURE p2 COMMENT 'testÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ';
DROP PROCEDURE p2;
CREATE DATABASE mysqltest;
DROP DATABASE mysqltest;
SELECT DATABASE();
