...
SELECT 
  ...
  a=@l FROM t1;
DROP TABLE t1;
SELECT 1 as ÃÂÃÂÃÂÃÂ, 2 as ÃÂÃÂÃÂÃÂ, 3 as ÃÂÃÂÃÂÃÂ, 4 as ÃÂÃÂÃÂÃÂ, 5 as ÃÂÃÂÃÂÃÂ, 6 as ÃÂÃÂÃÂÃÂ, 7 as ÃÂÃÂÃÂÃÂ, 8 as ÃÂÃÂÃÂÃÂ;
CREATE TABLE ÃÂÃÂÃÂÃÂa (a int);
SELECT 'ÃÂÃÂÃÂÃÂa' as str;
...
DROP TABLE IF EXISTS `abcÃÂÃÂÃÂÃÂ¿def`;
CREATE TABLE `abcÃÂÃÂÃÂÃÂ¿def` (i int);
INSERT INTO `abcÃÂÃÂÃÂÃÂ¿def` VALUES (1);
INSERT INTO abcÃÂÃÂÃÂÃÂ¿def VALUES (2);
SELECT * FROM `abcÃÂÃÂÃÂÃÂ¿def`;
SELECT * FROM abcÃÂÃÂÃÂÃÂ¿def;
DROP TABLE `abcÃÂÃÂÃÂÃÂ¿def`;
