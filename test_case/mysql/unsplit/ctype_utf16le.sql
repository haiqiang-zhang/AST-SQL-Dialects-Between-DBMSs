...
ALTER TABLE t1 CHANGE a a ENUM('x','y','z','d','e','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼') CHARACTER SET utf16le;
...
SELECT a, HEX(a) FROM t1 ORDER BY a;
DROP TABLE t1;
CREATE TABLE t1 (a set ('x','y','z','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼') CHARACTER SET utf16le);
INSERT INTO t1 VALUES ('x');
INSERT INTO t1 VALUES ('y');
INSERT INTO t1 VALUES ('z');
