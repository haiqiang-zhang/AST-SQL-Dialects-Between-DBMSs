...
DROP TABLE t1;
SELECT hex('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ');
SELECT hex('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ');
SELECT 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ' as s;
SELECT 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ' as s;
CREATE TABLE t1 (`ÃÂÃÂÃÂÃÂ¤` CHAR(128) DEFAULT 'ÃÂÃÂÃÂÃÂ¤', `ÃÂÃÂÃÂÃÂ¤1` ENUM('ÃÂÃÂÃÂÃÂ¤1','ÃÂÃÂÃÂÃÂ¤2') DEFAULT 'ÃÂÃÂÃÂÃÂ¤2');
DROP TABLE t1;
create table t1 (a char(10) character set koi8r, b text character set koi8r);
insert into t1 values ('test','test');
insert ignore into t1 values ('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ');
drop table t1;
...
select substring_index(c1,'ÃÂÃÂÃÂÃÂ¶ÃÂÃÂÃÂÃÂ¶ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ',2) from t1;
select trim(c1 from 'ÃÂÃÂÃÂÃÂ'),trim('ÃÂÃÂÃÂÃÂ' from c1) from t1;
drop table t1;
