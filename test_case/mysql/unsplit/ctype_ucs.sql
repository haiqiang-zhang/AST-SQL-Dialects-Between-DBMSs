...
INSERT INTO t1 VALUES (_koi8r'ÃÂÃÂÃÂÃÂ²',_koi8r'ÃÂÃÂÃÂÃÂ²'), (X'2004',X'2004');
...
SELECT * FROM t1 WHERE a LIKE '%ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ%';
SELECT * FROM t1 WHERE a LIKE '%ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂÃÂÃÂ%';
SELECT * FROM t1 WHERE a LIKE 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ%';
DROP TABLE t1;
...
alter table t1 change a a enum('x','y','z','d','e','ÃÂÃÂÃÂÃÂ¤','ÃÂÃÂÃÂÃÂ¶','ÃÂÃÂÃÂÃÂ¼') character set ucs2;
insert into t1 values ('D');
insert into t1 values ('E ');
select a, hex(a) from t1 order by a;
drop table t1;
create table t1 (a set ('x','y','z','ÃÂÃÂÃÂÃÂ¤','ÃÂÃÂÃÂÃÂ¶','ÃÂÃÂÃÂÃÂ¼') character set ucs2);
insert into t1 values ('x');
insert into t1 values ('y');
insert into t1 values ('z');
