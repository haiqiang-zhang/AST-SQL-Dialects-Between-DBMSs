...
CREATE TABLE t3 (`ÃÂÃÂÃÂÃÂ¤ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ` CHAR(1), `ÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ` CHAR(1), `ÃÂÃÂÃÂÃÂ¦ÃÂÃÂÃÂÃÂ®ÃÂÃÂÃÂÃÂµ` CHAR(1)) DEFAULT CHARSET = utf8mb4;
