...
alter table t1 change a a enum('x','y','z','d','e','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼') character set utf16;
...
select a, hex(a) from t1 order by a;
drop table t1;
create table t1 (a set ('x','y','z','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¶','ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼') character set utf16);
insert into t1 values ('x');
insert into t1 values ('y');
insert into t1 values ('z');
