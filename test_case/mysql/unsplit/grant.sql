...
create table t1 (a int);
drop table t1;
CREATE DATABASE ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ;
CREATE TABLE ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ (ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ INT);
DROP DATABASE ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ;
CREATE TABLE t1 (a int );
