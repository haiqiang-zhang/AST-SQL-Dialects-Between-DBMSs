...
drop view v1;
create table tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼ (cÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼ char);
create view vÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼ as select cÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼ from tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼;
select * from vÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼;
drop view vÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼;
drop table tÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¼;
create table t1 (a int, b int);
insert into t1 values (1,2), (1,3), (2,4), (2,5), (3,10);
...
update v7n set a='v7n v6c v5nÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ';
...
CREATE VIEW v1 AS SELECT c1,'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡' AS c2 FROM t1;
