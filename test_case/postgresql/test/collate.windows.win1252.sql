...
INSERT INTO collate_test1 VALUES (1, 'abc'), (2, 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤bc'), (3, 'bbc'), (4, 'ABC');
...
SELECT 'bbc' COLLATE "en_US" > 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤bc' COLLATE "en_US" AS "true";
SELECT 'bbc' COLLATE "sv_SE" > 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤bc' COLLATE "sv_SE" AS "false";
