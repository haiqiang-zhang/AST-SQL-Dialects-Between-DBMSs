...
SELECT 'ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
...
SELECT 'MÃÂÃÂÃÂÃÂ¼nchen' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
...
SELECT 'MÃÂÃÂÃÂÃÂ¼nchen-Ost' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'Bahnhof MÃÂÃÂÃÂÃÂ¼nchen-Ost' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'abÃÂÃÂÃÂÃÂ¦cdÃÂÃÂÃÂÃÂ¶ef' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'ÃÂÃÂÃÂÃÂ¿ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ²ÃÂÃÂÃÂÃÂ´ÃÂÃÂÃÂÃÂ°' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'ÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂ¢ÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂÃÂÃÂ ÃÂÃÂ¸ÃÂÃÂ' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ¡ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¥ÃÂÃÂÃÂÃÂÃÂÃÂ¤ÃÂÃÂ¾ÃÂÃÂ' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'MajiÃÂÃÂ£ÃÂÃÂÃÂÃÂ§KoiÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ5ÃÂÃÂ§ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¥ÃÂÃÂÃÂÃÂ' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'ÃÂÃÂ£ÃÂÃÂÃÂÃÂbÃÂÃÂÃÂÃÂ¼cherÃÂÃÂ£ÃÂÃÂÃÂÃÂ' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
SELECT 'ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ¢ÃÂÃÂ¦ÃÂÃÂ·ÃÂÃÂ' AS str, punycodeEncode(str) AS puny, punycodeDecode(puny) AS original, tryPunycodeDecode(puny) AS original_try;
...
INSERT INTO tab VALUES ('abc') ('aÃÂÃÂÃÂÃÂ¤oÃÂÃÂÃÂÃÂ¶uÃÂÃÂÃÂÃÂ¼') ('MÃÂÃÂÃÂÃÂ¼nchen');
