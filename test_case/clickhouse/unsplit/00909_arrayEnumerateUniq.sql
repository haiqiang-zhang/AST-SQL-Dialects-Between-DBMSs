...
-- ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂµÃÂÃÂ¼ ÃÂÃÂ²ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ¶ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ½ÃÂÃÂ¸ÃÂÃÂ ÃÂÃÂ³ÃÂÃÂ»ÃÂÃÂ¾ÃÂÃÂ±ÃÂÃÂ°ÃÂÃÂ»ÃÂÃÂÃÂÃÂ½ÃÂÃÂ¾ ÃÂÃÂ¿ÃÂÃÂ¾ ÃÂÃÂ²ÃÂÃÂÃÂÃÂµÃÂÃÂ¼ÃÂÃÂ ÃÂÃÂ·ÃÂÃÂ½ÃÂÃÂ°ÃÂÃÂÃÂÃÂµÃÂÃÂ½ÃÂÃÂ¸ÃÂÃÂ ÃÂÃÂ² ÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ»ÃÂÃÂ±ÃÂÃÂÃÂÃÂµ, ÃÂÃÂÃÂÃÂ¼ÃÂÃÂ¾ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂ¼ ÃÂÃÂ² ÃÂÃÂ³ÃÂÃÂ»ÃÂÃÂÃÂÃÂ±ÃÂÃÂ¸ÃÂÃÂ½ÃÂÃÂ ÃÂÃÂ½ÃÂÃÂ° ÃÂÃÂ´ÃÂÃÂ²ÃÂÃÂ° ÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ²ÃÂÃÂ½ÃÂÃÂ,
-- "ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂ½ÃÂÃÂ¾ÃÂÃÂ¼ÃÂÃÂµÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂµ" ÃÂÃÂ¼ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂ²ÃÂÃÂ ÃÂÃÂ¼ÃÂÃÂÃÂÃÂÃÂÃÂ»ÃÂÃÂµÃÂÃÂ½ÃÂÃÂ½ÃÂÃÂ¾ ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂ¸ÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂµÃÂÃÂ¼ ÃÂÃÂ´ÃÂÃÂ¾ "ÃÂÃÂ´ÃÂÃÂ²ÃÂÃÂÃÂÃÂÃÂÃÂ¼ÃÂÃÂµÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂ", ÃÂÃÂ¾ÃÂÃÂÃÂÃÂ²ÃÂÃÂµÃÂÃÂ [[,,],[,,],[]]
...
select '2,..,2';
-- ÃÂÃÂ´ÃÂÃÂÃÂÃÂ±ÃÂÃÂ»ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂ¼ ÃÂÃÂ»ÃÂÃÂ¾ÃÂÃÂ³ÃÂÃÂ¸ÃÂÃÂºÃÂÃÂ arrayMap( aEU), ÃÂÃÂ¾ÃÂÃÂÃÂÃÂ²ÃÂÃÂµÃÂÃÂ [[,,],[,,],[]]
SELECT '[[1,1,1],[1,2,1],[1]] =';
...
-- ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂµÃÂÃÂ¼ ÃÂÃÂ²ÃÂÃÂÃÂÃÂ¾ÃÂÃÂ¶ÃÂÃÂ´ÃÂÃÂµÃÂÃÂ½ÃÂÃÂ¸ÃÂÃÂ ÃÂÃÂ² ÃÂÃÂ¾ÃÂÃÂÃÂÃÂ´ÃÂÃÂµÃÂÃÂ»ÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂ ÃÂÃÂ¼ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂ ÃÂÃÂ¿ÃÂÃÂµÃÂÃÂÃÂÃÂ²ÃÂÃÂ¾ÃÂÃÂ³ÃÂÃÂ¾ ÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ²ÃÂÃÂ½ÃÂÃÂ, ÃÂÃÂÃÂÃÂ¼ÃÂÃÂ¾ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂ¼ ÃÂÃÂ² ÃÂÃÂ³ÃÂÃÂ»ÃÂÃÂÃÂÃÂ±ÃÂÃÂ¸ÃÂÃÂ½ÃÂÃÂ ÃÂÃÂ½ÃÂÃÂ° ÃÂÃÂ´ÃÂÃÂ²ÃÂÃÂ° ÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂ²ÃÂÃÂ½ÃÂÃÂ,
-- "ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂ½ÃÂÃÂ¾ÃÂÃÂ¼ÃÂÃÂµÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂµ" ÃÂÃÂ¼ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¸ÃÂÃÂ²ÃÂÃÂ ÃÂÃÂ¼ÃÂÃÂÃÂÃÂÃÂÃÂ»ÃÂÃÂµÃÂÃÂ½ÃÂÃÂ½ÃÂÃÂ¾ ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂ¸ÃÂÃÂ²ÃÂÃÂ°ÃÂÃÂµÃÂÃÂ¼ ÃÂÃÂ´ÃÂÃÂ¾ "ÃÂÃÂ´ÃÂÃÂ²ÃÂÃÂÃÂÃÂÃÂÃÂ¼ÃÂÃÂµÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂ", ÃÂÃÂ´ÃÂÃÂÃÂÃÂ±ÃÂÃÂ»ÃÂÃÂ¸ÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂ¼ ÃÂÃÂ»ÃÂÃÂ¾ÃÂÃÂ³ÃÂÃÂ¸ÃÂÃÂºÃÂÃÂ arrayMap( aEU), ÃÂÃÂ¾ÃÂÃÂÃÂÃÂ²ÃÂÃÂµÃÂÃÂ [[,,],[,,],[]]
SELECT '[[1,1,1],[1,2,1],[1]] =';
