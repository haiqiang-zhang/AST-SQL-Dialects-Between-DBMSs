...
select lower('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA') = 'aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂaaaaaaaa';
select upper('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA') = 'AAAAÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAAAAA';
select lowerUTF8('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA') = 'aaaaÃÂÃÂ°ÃÂÃÂ±ÃÂÃÂ²ÃÂÃÂ³aaaaaaaa';
select upperUTF8('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA') = 'AAAAÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAAAAA';
select sum(lower(materialize('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA')) = materialize('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂaaaaaaaa')) = count() from system.one array join range(16384) as n;
select sum(upper(materialize('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA')) = materialize('AAAAÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAAAAA')) = count() from system.one array join range(16384) as n;
select sum(lowerUTF8(materialize('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA')) = materialize('aaaaÃÂÃÂ°ÃÂÃÂ±ÃÂÃÂ²ÃÂÃÂ³aaaaaaaa')) = count() from system.one array join range(16384) as n;
select sum(upperUTF8(materialize('aaaaÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAaaAA')) = materialize('AAAAÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂAAAAAAAA')) = count() from system.one array join range(16384) as n;
