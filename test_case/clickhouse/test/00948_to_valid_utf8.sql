...
select toValidUTF8('Ã¬ÂÂÃ«ÂÂÃ­ÂÂÃ¬ÂÂ¸Ã¬ÂÂ, Ã¬ÂÂ¸Ã¬ÂÂ') from system.numbers limit 10;
...
select 1 = isValidUTF8(toValidUTF8('ÃÂºÃÂ°ÃÂºÃÂ¾ÃÂ¹-ÃÂÃÂ¾ ÃÂÃÂµÃÂºÃÂÃÂ')) from system.numbers limit 10;
...
select 1 = isValidUTF8(toValidUTF8('Ã¬ÂÂÃ«ÂÂÃ­ÂÂÃ¬ÂÂ¸Ã¬ÂÂ, Ã¬ÂÂ¸Ã¬ÂÂ')) from system.numbers limit 10;
