...
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂ·ÃÂ´')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), materialize('')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), materialize('ÃÂ³ÃÂ´ÃÂµÃÂÃÂ·ÃÂ´')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂ·ÃÂ´')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8('', materialize('')))=round(1000 * ngramDistanceUTF8(materialize(''), '')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²', materialize('')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8('', materialize('ÃÂ°ÃÂ±ÃÂ²')))=round(1000 * ngramDistanceUTF8(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶')) from system.numbers limit 5;
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', materialize('ÃÂ³ÃÂ´ÃÂµÃÂÃÂ·ÃÂ´')))=round(1000 * ngramDistanceUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂ·ÃÂ´')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²', ''));
select round(1000 * ngramDistanceUTF8('', 'ÃÂ°ÃÂ±ÃÂ²'));
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'));
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', 'ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶'));
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂ·ÃÂ´'));
select round(1000 * ngramDistanceUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ'));
drop table if exists test_distance;
create table test_distance (Title String) engine = Memory;
insert into test_distance values ('ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ°?... ÃÂ¥ÃÂµÃÂÃÂÃÂ¾ÃÂ½'), ('ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ° ÃÂºÃÂ»ÃÂ¸ÃÂ¿ - TUT.BY'), ('ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ'), ('ÃÂ¿ÃÂ°ÃÂ¿ ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ° - TUT.BY'), ('ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂ±ÃÂÃÂ°ÃÂÃÂ°ÃÂ½ ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ° - TUT.BY'), ('http://metric.ru/'), ('http://autometric.ru/'), ('http://top.bigmir.net/'), ('http://metris.ru/'), ('http://metrika.ru/'), ('');
...
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceUTF8(Title, 'ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ°') as distance, Title;
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceUTF8(Title, 'ÃÂºÃÂ°ÃÂº ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂ´ÃÂµÃÂ»ÃÂ°') as distance, Title;
...
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂÃÂÃÂÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂÃÂÃÂ¶ÃÂ·')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂÃÂ')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'),materialize(''))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize(''), materialize('ÃÂ°ÃÂ±ÃÂ²'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂÃÂÃÂÃÂÃÂ¶ÃÂ·'), materialize('ÃÂÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂÃÂÃÂ¶ÃÂ·'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂÃÂÃÂÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂÃÂÃÂ¶ÃÂ·')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂÃÂÃÂÃÂ´ÃÂµÃÂÃÂÃÂ·'), materialize('ÃÂÃÂ±ÃÂ²ÃÂÃÂ´ÃÂµÃÂÃÂ¶'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂÃÂÃÂÃÂ´ÃÂµÃÂÃÂÃÂ·'), 'ÃÂÃÂ±ÃÂ²ÃÂÃÂ´ÃÂµÃÂÃÂ¶')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), materialize('ÃÂ³ÃÂ´ÃÂµÃÂÃÂÃÂ'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂÃÂ')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²',materialize(''))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂÃÂÃÂÃÂÃÂ¶ÃÂ·', materialize('ÃÂÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂÃÂÃÂ¶ÃÂ·'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂÃÂÃÂÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂÃÂÃÂ¶ÃÂ·')) from system.numbers limit 5;
...
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', materialize('ÃÂ³ÃÂ´ÃÂµÃÂÃÂÃÂ'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂ³ÃÂ´ÃÂµÃÂÃÂÃÂ')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·', materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ'))) = round(1000 * ngramDistanceCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂµÃÂÃÂ¶ÃÂ·'), 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ')) from system.numbers limit 5;
select round(1000 * ngramDistanceCaseInsensitiveUTF8('', ''));
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²', ''));
select round(1000 * ngramDistanceCaseInsensitiveUTF8('', 'ÃÂ°ÃÂ±ÃÂ²'));
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂÃÂÃÂÃÂÃÂ¶ÃÂ·', 'ÃÂÃÂ±ÃÂ²ÃÂ³ÃÂ´ÃÂÃÂÃÂ¶ÃÂ·'));
select round(1000 * ngramDistanceCaseInsensitiveUTF8('ÃÂ°ÃÂÃÂÃÂÃÂ´ÃÂµÃÂÃÂÃÂ·', 'ÃÂÃÂ±ÃÂ²ÃÂÃÂ´ÃÂµÃÂÃÂ¶'));
...
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceCaseInsensitiveUTF8(Title, extract(Title, 'ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ°')) as distance, Title;
...
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceCaseInsensitiveUTF8(Title, 'ÃÂÃÂÃÂÃÂ²ÃÂÃÂ ÃÂºÃÂÃÂ ÃÂÃÂÃÂÃÂ°') as distance, Title;
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceCaseInsensitiveUTF8(Title, 'ÃÂºÃÂ°ÃÂº ÃÂÃÂ ÃÂÃÂÃÂÃÂ¢ ÃÂ´ÃÂµÃÂ»ÃÂ°') as distance, Title;
...
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceCaseInsensitiveUTF8(Title, 'ÃÂ¿ÃÂÃÂ¸ÃÂÃÂÃÂ¢ ÃÂÃÂÃÂº ÃÂÃÂµÃÂÃÂ° ÃÂÃÂ»ÃÂÃÂ¿ - TuT.by') as distance, Title;
...
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistance(Title, 'ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂºÃÂ°ÃÂº ÃÂ´ÃÂµÃÂ»ÃÂ°') as distance, Title;
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistance(Title, 'ÃÂºÃÂ°ÃÂº ÃÂ¿ÃÂÃÂ¸ÃÂ²ÃÂµÃÂ ÃÂ´ÃÂµÃÂ»ÃÂ°') as distance, Title;
...
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceCaseInsensitive(Title, 'ÃÂÃÂÃÂÃÂ²ÃÂÃÂ ÃÂºÃÂÃÂ ÃÂÃÂÃÂÃÂ°') as distance, Title;
SELECT Title, round(1000 * distance) FROM test_distance ORDER BY ngramDistanceCaseInsensitive(Title, 'ÃÂºÃÂ°ÃÂº ÃÂÃÂ ÃÂÃÂÃÂÃÂ¢ ÃÂ´ÃÂµÃÂ»ÃÂ°') as distance, Title;
