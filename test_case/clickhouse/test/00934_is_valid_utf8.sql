...
select 1 = isValidUTF8('ÃÂÃÂºÃÂÃÂ°ÃÂÃÂºÃÂÃÂ¾ÃÂÃÂ¹-ÃÂÃÂÃÂÃÂ¾ ÃÂÃÂÃÂÃÂµÃÂÃÂºÃÂÃÂÃÂÃÂ') from system.numbers limit 10;
...
select 1 = isValidUTF8('ÃÂ¬ÃÂÃÂÃÂ«ÃÂÃÂÃÂ­ÃÂÃÂÃÂ¬ÃÂÃÂ¸ÃÂ¬ÃÂÃÂ, ÃÂ¬ÃÂÃÂ¸ÃÂ¬ÃÂÃÂ') from system.numbers limit 10;
