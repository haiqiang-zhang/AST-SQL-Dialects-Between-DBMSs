...
select 0 = position('ÃÂ°ÃÂ±ÃÂ²' in '');
select 1 = position('ÃÂ°ÃÂ±ÃÂ²' in 'ÃÂ°ÃÂ±ÃÂ²');
select 3 = position('ÃÂ±ÃÂ²' in 'ÃÂ°ÃÂ±ÃÂ²');
select 5 = position('ÃÂ²' in 'ÃÂ°ÃÂ±ÃÂ²');
