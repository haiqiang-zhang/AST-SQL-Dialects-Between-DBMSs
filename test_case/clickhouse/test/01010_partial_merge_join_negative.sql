...
SELECT * FROM t0 ANTI RIGHT JOIN t1 ON t1.x = t0.x;
SELECT * FROM t0 ANTI LEFT JOIN t1 USING (x);
SELECT * FROM t0 ANTI RIGHT JOIN t1 USING (x);
SELECT 'asof';
SELECT * FROM t0 ASOF LEFT JOIN t1 ON t1.x = t0.x AND t0.y > t1.y;
SELECT * FROM t0 ASOF LEFT JOIN t1 USING (x, y);
DROP TABLE t0;
DROP TABLE t1;