...
select 42::UInt32::Variant(String, UInt64);
select now()::Variant(String, UInt64);
...
select 'str'::Variant(String, UInt64)::UInt64;
...
select CAST(multiIf(number == 1, NULL::Variant(String, UInt64), number == 2, 'Hello'::Variant(String, UInt64), number::Variant(String, UInt64)), 'UInt64') from numbers(6);
select number::Variant(UInt64)::Variant(String, UInt64)::Variant(Array(String), String, UInt64) from numbers(2);
select 'str'::Variant(String, UInt64)::Variant(String, Array(UInt64));