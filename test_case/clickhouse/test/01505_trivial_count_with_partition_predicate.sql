...
select count() from test_tuple array join [p,p] as c where toDate(p) = '2020-09-01';
select count() from test_tuple array join [1,2] as c where toDate(p) = '2020-09-01' settings max_rows_to_read = 4;
select count() from test_tuple array join [1,2,3] as c where toDate(p) = '2020-09-01';
...
select count() from test_two_args where i = 1;
drop table test1;
