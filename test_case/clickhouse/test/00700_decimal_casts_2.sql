...
SELECT toDecimal128('-1', 7) AS x, toUInt32(x);
SELECT toDecimal128('-1', 7) AS x, toUInt16(x);
SELECT toDecimal128('-1', 7) AS x, toUInt8(x);
SELECT toDecimal64('-1', 5) AS x, toUInt64(x);
SELECT toDecimal64('-1', 5) AS x, toUInt32(x);
SELECT toDecimal64('-1', 5) AS x, toUInt16(x);
SELECT toDecimal64('-1', 5) AS x, toUInt8(x);
SELECT toDecimal32('-1', 3) AS x, toUInt64(x);
SELECT toDecimal32('-1', 3) AS x, toUInt32(x);
SELECT toDecimal32('-1', 3) AS x, toUInt16(x);
SELECT toDecimal32('-1', 3) AS x, toUInt8(x);
...
SELECT toInt64('-2147483649') AS x, toDecimal32(x, 0);
SELECT toUInt64('2147483649') AS x, toDecimal32(x, 0);
