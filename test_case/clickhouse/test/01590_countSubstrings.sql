...
select 'CountSubstringsImpl::constantConstantScalar';
select 'char';
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂÃÂÃÂÃÂÃÂ', 'ÃÂÃÂ¤');
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ¤', 'ÃÂÃÂ');
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ¤ÃÂÃÂÃÂÃÂ¤', 'ÃÂÃÂ');
select 'word';
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°.ÃÂÃÂÃÂÃÂ', 'ÃÂÃÂ ÃÂÃÂ¤');
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂÃÂÃÂ.ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°', 'ÃÂÃÂÃÂÃÂ');
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°.ÃÂÃÂÃÂÃÂ.ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°', 'ÃÂÃÂ ÃÂÃÂ¤');
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂÃÂÃÂ.ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°.ÃÂÃÂÃÂÃÂ', 'ÃÂÃÂÃÂÃÂ');
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂÃÂÃÂ.ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°.ÃÂÃÂÃÂÃÂ.ÃÂÃÂ¿ÃÂÃÂ¾ÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¾ÃÂÃÂºÃÂÃÂ°.ÃÂÃÂÃÂÃÂ', 'ÃÂÃÂ ÃÂÃÂ¤');
select 'intersect';
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ', 'ÃÂÃÂ¯ÃÂÃÂ¯');
select '';
select 'CountSubstringsImpl::vectorVector';
-- for the haystack we use number as-is, for needle we just add dependency from number to go to vectorVector code
select countSubstringsCaseInsensitiveUTF8(upperUTF8(concat(char(number), 'ÃÂÃÂ')), lowerUTF8(concat(substringUTF8(char(number), 2), 'ÃÂÃÂ¯'))) from numbers(100) where number = 0x41;
select countSubstringsCaseInsensitiveUTF8(concat(toString(number), 'ÃÂÃÂ¯ÃÂÃÂ¯ÃÂÃÂ¯111'), concat(substringUTF8(char(number), 2), 'ÃÂÃÂ')) from numbers(100) where number = 0x41;
select countSubstringsCaseInsensitiveUTF8(concat(toString(number), 'ÃÂÃÂÃÂÃÂÃÂÃÂ111ÃÂÃÂÃÂÃÂ1'), concat(substringUTF8(char(number), 2), 'ÃÂÃÂ¯')) from numbers(100) where number = 0x41;
select '';
select 'CountSubstringsImpl::constantVector';
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¯ÃÂÃÂ¯b', concat(substringUTF8(char(number), 2), 'ÃÂÃÂ')) from numbers(100) where number = 0x41;
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¯bÃÂÃÂ¯ÃÂÃÂ¯', concat(substringUTF8(char(number), 2), 'ÃÂÃÂ')) from numbers(100) where number = 0x41;
select countSubstringsCaseInsensitiveUTF8('ÃÂÃÂ¯bÃÂÃÂ¯ÃÂÃÂ¯ÃÂÃÂ¯ÃÂÃÂ¯', concat(substringUTF8(char(number), 2), 'ÃÂÃÂ')) from numbers(100) where number = 0x41;
select '';
select 'CountSubstringsImpl::vectorConstant';
select countSubstringsCaseInsensitiveUTF8(concat(char(number), 'ÃÂÃÂ'), 'ÃÂÃÂ¯') from numbers(100) where number = 0x41;
select countSubstringsCaseInsensitiveUTF8(concat(char(number), 'ÃÂÃÂ±'), 'ÃÂÃÂ¯') from numbers(100) where number = 0x41;
