...
SELECT a FROM prewhere_int128 PREWHERE a;
...
SELECT a FROM prewhere_int256 PREWHERE a;
...
SELECT a FROM prewhere_uint128 PREWHERE a;
...
SELECT a FROM prewhere_uint256 PREWHERE a;
