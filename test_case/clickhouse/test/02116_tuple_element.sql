...
SELECT tupleElement(t1) FROM t_tuple_element;
SELECT tupleElement(t1, 'b') FROM t_tuple_element;
SELECT tupleElement(t1, 0) FROM t_tuple_element;
SELECT tupleElement(t1, 3) FROM t_tuple_element;
SELECT tupleElement(t1, materialize('a')) FROM t_tuple_element;
...
SELECT tupleElement(t2, 'a') FROM t_tuple_element;
SELECT tupleElement(t2, 0) FROM t_tuple_element;
SELECT tupleElement(t2, 3) FROM t_tuple_element;
SELECT tupleElement(t2, materialize(1)) FROM t_tuple_element;
