...
ALTER TABLE table_for_rename_pk RENAME COLUMN key3 TO renamed_key3;
ALTER TABLE table_for_rename_pk RENAME COLUMN key2 TO renamed_key2;
DROP TABLE IF EXISTS table_for_rename_pk;
...
ALTER TABLE table_for_rename_with_primary_key RENAME COLUMN key2 TO renamed_key2;
ALTER TABLE table_for_rename_with_primary_key RENAME COLUMN key3 TO renamed_key3;
DROP TABLE IF EXISTS table_for_rename_with_primary_key;