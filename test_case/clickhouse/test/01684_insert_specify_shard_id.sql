...
INSERT INTO y_dist SELECT * FROM numbers(10);
-- invalid shard id
INSERT INTO x_dist SELECT * FROM numbers(10) settings insert_shard_id = 3;
INSERT INTO y_dist SELECT * FROM numbers(10) settings insert_shard_id = 3;
DROP TABLE x;
DROP TABLE x_dist;
DROP TABLE y;
DROP TABLE y_dist;