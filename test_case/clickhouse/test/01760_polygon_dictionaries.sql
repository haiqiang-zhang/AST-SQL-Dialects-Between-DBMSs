...
SELECT tuple(nan, nan) as key, dictGet('01760_db.dict_array', 'name', key);
SELECT tuple(inf, nan) as key, dictGet('01760_db.dict_array', 'name', key);
SELECT tuple(inf, inf) as key, dictGet('01760_db.dict_array', 'name', key);
