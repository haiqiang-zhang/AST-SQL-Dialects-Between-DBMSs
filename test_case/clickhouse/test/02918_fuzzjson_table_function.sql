...
DROP TABLE IF EXISTS 02918_table_str;
SELECT * FROM fuzzJSON(02918_json_fuzzer, max_output_length="Hello") LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, max_output_length=65537) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, probability=10) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, probability=-0.1) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, probability=1.1) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, probability=1.1) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, max_string_value_length=65537) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, max_key_length=65537) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, max_key_length=10, min_key_length=0) LIMIT 10;
SELECT * FROM fuzzJSON(02918_json_fuzzer, max_key_length=10, min_key_length=11) LIMIT 10;
--
...
INSERT INTO 02918_table_obj2 SELECT * FROM fuzzJSON(
    ...
    random_seed=12345,
    max_output_length=1024, malform_output=true) LIMIT 50;
