...
SELECT sparkbar(0)(number, number) FROM numbers(10);
SELECT sparkbar(1)(number, number) FROM numbers(10);
SELECT sparkbar(1025)(number, number) FROM numbers(10);
SELECT sparkbar(2, 10, 9)(number, number) FROM numbers(10);
SELECT sparkbar(2, -5, -1)(number, number) FROM numbers(10);
SELECT sparkbar(2, -5, 1)(number, number) FROM numbers(10);
SELECT sparkbar(2)(toInt32(number),  number) FROM numbers(10);
SELECT sparkbar(2, 0)(number, number) FROM numbers(10);
SELECT sparkbar(2, 0, 5, 8)(number, number) FROM numbers(10);
DROP TABLE IF EXISTS spark_bar_test;