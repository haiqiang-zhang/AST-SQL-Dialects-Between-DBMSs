...
SELECT transform(1, [2, 3], ['Meta.ua', 'Google'], materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂ»ÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂµ')) AS title;
SELECT transform(2, [2, 3], ['Meta.ua', 'Google'], materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂ»ÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂµ')) AS title;
SELECT transform(3, [2, 3], ['Meta.ua', 'Google'], materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂ»ÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂµ')) AS title;
SELECT transform(4, [2, 3], ['Meta.ua', 'Google'], materialize('ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°ÃÂÃÂ»ÃÂÃÂÃÂÃÂ½ÃÂÃÂÃÂÃÂµ')) AS title;
