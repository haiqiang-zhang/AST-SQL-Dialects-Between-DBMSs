...
select 1 = position('', '');
select 1 = position('ÃÂ°ÃÂ±ÃÂ²', '');
select 0 = position('', 'ÃÂ°ÃÂ±ÃÂ²');
select 1 = position('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ°ÃÂ±ÃÂ²');
select 3 = position('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±ÃÂ²');
select 5 = position('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ²');
...
select 1 = position(materialize(''), '');
select 1 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), '');
select 0 = position(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²');
select 1 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂ±ÃÂ²');
select 3 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±ÃÂ²');
select 5 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ²');
select 1 = position(materialize(''), '') from system.numbers limit 10;
select 1 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), '') from system.numbers limit 10;
select 0 = position(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²') from system.numbers limit 10;
select 1 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂ±ÃÂ²') from system.numbers limit 10;
select 3 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±ÃÂ²') from system.numbers limit 10;
select 5 = position(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ²') from system.numbers limit 10;
select 1 = positionUTF8('', '');
select 1 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²', '');
select 0 = positionUTF8('', 'ÃÂ°ÃÂ±ÃÂ²');
select 1 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ°ÃÂ±ÃÂ²');
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±ÃÂ²');
select 3 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ²');
select 3 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 2);
select 3 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 3);
select 3 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±ÃÂ²ÃÂ°', 2);
select 9 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 4);
select 0 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±ÃÂ²ÃÂ°', 4);
select 5 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ²', 0);
select 11 = position('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ²', 6);
select 1 = positionUTF8(materialize(''), '');
select 1 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '');
select 0 = positionUTF8(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²');
select 1 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂ±ÃÂ²');
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±ÃÂ²');
select 3 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ²');
select 1 = positionUTF8(materialize(''), '') from system.numbers limit 10;
select 1 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '') from system.numbers limit 10;
select 0 = positionUTF8(materialize(''), 'ÃÂ°ÃÂ±ÃÂ²') from system.numbers limit 10;
select 1 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂ±ÃÂ²') from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±ÃÂ²') from system.numbers limit 10;
select 3 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ²') from system.numbers limit 10;
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 0);
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 1);
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 2);
select 5 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 3);
select 5 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 4);
select 5 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 5);
select 0 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', 6);
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±ÃÂ²ÃÂ°', 0);
select 0 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±ÃÂ²ÃÂ°', 3);
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 0) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 1) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 2) from system.numbers limit 10;
select 5 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 3) from system.numbers limit 10;
select 5 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 4) from system.numbers limit 10;
select 5 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 5) from system.numbers limit 10;
select 0 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', 6) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±ÃÂ²ÃÂ°', 0) from system.numbers limit 10;
select 0 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±ÃÂ²ÃÂ°', 3) from system.numbers limit 10;
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 0) from system.numbers limit 10;
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 1) from system.numbers limit 10;
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 2) from system.numbers limit 10;
select 5 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 3) from system.numbers limit 10;
select 5 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 4) from system.numbers limit 10;
select 5 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 5) from system.numbers limit 10;
select 0 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), 6) from system.numbers limit 10;
select 2 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±ÃÂ²ÃÂ°'), 0) from system.numbers limit 10;
select 0 = positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±ÃÂ²ÃÂ°'), 3) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 0) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 1) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 2) from system.numbers limit 10;
select 5 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 3) from system.numbers limit 10;
select 5 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 4) from system.numbers limit 10;
select 5 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 5) from system.numbers limit 10;
select 0 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±'), 6) from system.numbers limit 10;
select 2 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±ÃÂ²ÃÂ°'), 0) from system.numbers limit 10;
select 0 = positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), materialize('ÃÂ±ÃÂ²ÃÂ°'), 3) from system.numbers limit 10;
...
select [2, 2, 2, 5, 5, 5, 0, 0, 0, 0] = groupArray(positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', materialize('ÃÂ±'), number)) from numbers(10);
select [2, 2, 2, 5, 5, 5, 0, 0, 0, 0] = groupArray(positionUTF8('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ±', number)) from numbers(10);
select [2, 2, 2, 5, 5, 5, 0, 0, 0, 0] = groupArray(positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ±', number)) from numbers(10);
...
select 0 = positionCaseInsensitive('', 'ÃÂ°ÃÂÃÂ²');
select 0 = positionCaseInsensitive('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ°ÃÂÃÂ²');
select 0 = positionCaseInsensitive('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂÃÂ²');
select 0 = positionCaseInsensitive('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ');
select 1 = positionCaseInsensitive(materialize(''), '');
select 1 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), '');
select 0 = positionCaseInsensitive(materialize(''), 'ÃÂ°ÃÂÃÂ²');
select 0 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂÃÂ²');
select 0 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂÃÂ²');
select 0 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ');
select 1 = positionCaseInsensitive(materialize(''), '') from system.numbers limit 10;
select 1 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), '') from system.numbers limit 10;
select 0 = positionCaseInsensitive(materialize(''), 'ÃÂ°ÃÂÃÂ²') from system.numbers limit 10;
select 0 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂÃÂ²') from system.numbers limit 10;
select 0 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂÃÂ²') from system.numbers limit 10;
select 0 = positionCaseInsensitive(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ') from system.numbers limit 10;
select 1 = positionCaseInsensitiveUTF8('', '');
select 1 = positionCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²', '');
select 0 = positionCaseInsensitiveUTF8('', 'ÃÂ°ÃÂÃÂ²');
select 1 = positionCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ°ÃÂÃÂ²');
select 2 = positionCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂÃÂ²');
select 3 = positionCaseInsensitiveUTF8('ÃÂ°ÃÂ±ÃÂ²', 'ÃÂ²');
select 1 = positionCaseInsensitiveUTF8(materialize(''), '');
select 1 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '');
select 0 = positionCaseInsensitiveUTF8(materialize(''), 'ÃÂ°ÃÂÃÂ²');
select 1 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂÃÂ²');
select 2 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂÃÂ²');
select 3 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ');
select 1 = positionCaseInsensitiveUTF8(materialize(''), '') from system.numbers limit 10;
select 1 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), '') from system.numbers limit 10;
select 0 = positionCaseInsensitiveUTF8(materialize(''), 'ÃÂ°ÃÂÃÂ²') from system.numbers limit 10;
select 1 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ°ÃÂÃÂ²') from system.numbers limit 10;
select 2 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂÃÂ²') from system.numbers limit 10;
select 3 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ') from system.numbers limit 10;
select 6 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ', 4);
select 6 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ', 4) from system.numbers limit 10;
select 6 = positionCaseInsensitiveUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²ÃÂ°ÃÂ±ÃÂ²'), 'ÃÂ', materialize(4)) from system.numbers limit 10;
...
select position('' as h, lower('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitive(h, n);
select position('ÃÂ°ÃÂ±ÃÂ²' as h, lower('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitive(h, n);
select position('ÃÂ°ÃÂ±ÃÂ²' as h, lower('ÃÂÃÂ²' as n)) = positionCaseInsensitive(h, n);
select position('ÃÂ°ÃÂ±ÃÂ²' as h, lower('ÃÂ' as n)) = positionCaseInsensitive(h, n);
select position(materialize('') as h, lower('' as n)) = positionCaseInsensitive(h, n);
select position(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lower('' as n)) = positionCaseInsensitive(h, n);
...
select position(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lower('ÃÂÃÂ²' as n)) = positionCaseInsensitive(h, n);
...
select position(materialize('') as h, lower('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitive(h, n) from system.numbers limit 10;
...
select position(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lower('ÃÂÃÂ²' as n)) = positionCaseInsensitive(h, n) from system.numbers limit 10;
...
select positionUTF8('ÃÂ°ÃÂ±ÃÂ²' as h, lowerUTF8('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n);
select positionUTF8('ÃÂ°ÃÂ±ÃÂ²' as h, lowerUTF8('ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n);
select positionUTF8('ÃÂ°ÃÂ±ÃÂ²' as h, lowerUTF8('ÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n);
...
select positionUTF8(materialize('') as h, lowerUTF8('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n);
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n);
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n);
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('ÃÂ' as n)) = positionCaseInsensitiveUTF8(h, n);
select positionUTF8(materialize('') as h, lowerUTF8('' as n)) = positionCaseInsensitiveUTF8(h, n) from system.numbers limit 10;
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('' as n)) = positionCaseInsensitiveUTF8(h, n) from system.numbers limit 10;
select positionUTF8(materialize('') as h, lowerUTF8('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n) from system.numbers limit 10;
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('ÃÂ°ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n) from system.numbers limit 10;
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('ÃÂÃÂ²' as n)) = positionCaseInsensitiveUTF8(h, n) from system.numbers limit 10;
select positionUTF8(materialize('ÃÂ°ÃÂ±ÃÂ²') as h, lowerUTF8('ÃÂ' as n)) = positionCaseInsensitiveUTF8(h, n) from system.numbers limit 10;
