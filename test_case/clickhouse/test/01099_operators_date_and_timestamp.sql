...
select (date '2001-09-29' + interval 12345 microsecond) x, toTypeName(x);
select (date '2001-09-29' + interval 12345 nanosecond) x, toTypeName(x);
select (date '2001-09-29' - interval 12345 second) x, toTypeName(x);
select (date '2001-09-29' - interval 12345 millisecond) x, toTypeName(x);
select (date '2001-09-29' - interval 12345 microsecond) x, toTypeName(x);
select (date '2001-09-29' - interval 12345 nanosecond) x, toTypeName(x);
...
select (toDate32('2001-09-29') + interval 12345 microsecond) x, toTypeName(x);
select (toDate32('2001-09-29') + interval 12345 nanosecond) x, toTypeName(x);
select (toDate32('2001-09-29') - interval 12345 second) x, toTypeName(x);
select (toDate32('2001-09-29') - interval 12345 millisecond) x, toTypeName(x);
select (toDate32('2001-09-29') - interval 12345 microsecond) x, toTypeName(x);
select (toDate32('2001-09-29') - interval 12345 nanosecond) x, toTypeName(x);
...
select interval '1 day' - interval '1 hour';
-- select (21 * interval '1 day') x, toTypeName(x);
-- select (double precision '3.5' * interval '1 hour') x, toTypeName(x);
-- select (interval '1 hour' / double precision '1.5') x, toTypeName(x);