...
DROP TABLE "t9";
DROP TABLE "tbl2";
CREATE TABLE abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef(a, b, c);
SELECT max(oid) FROM sqlite_master;
SELECT sql FROM sqlite_master WHERE oid = 16;
SELECT * FROM abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef;
ALTER TABLE abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef RENAME TO abcXdef;
SELECT sql FROM sqlite_master WHERE oid = 16;
ALTER TABLE abcXdef RENAME TO abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef;
SELECT sql FROM sqlite_master WHERE oid = 16;
ALTER TABLE abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef ADD COLUMN ghiS4jkl VARCHAR;
SELECT sql FROM sqlite_master WHERE oid = 16;
ALTER TABLE abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef ADD COLUMN BÃÂÃÂÃÂÃÂ¢1A;
SELECT sql FROM sqlite_master WHERE oid = 16;
INSERT INTO abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef VALUES(1, 2, 3, 4, 5);
SELECT ghiS4jkl, BÃÂÃÂÃÂÃÂ¢1A FROM abcÃÂÃÂªÃÂÃÂ¯ÃÂÃÂdef;
...
ALTER TABLE xyz RENAME TO xyzÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´abc;
SELECT name FROM sqlite_master WHERE name GLOB 'xyz*';
SELECT name FROM sqlite_master WHERE name GLOB 'sqlite_autoindex*';
ALTER TABLE xyzÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´abc RENAME TO xyzabc;
SELECT name FROM sqlite_master WHERE name GLOB 'xyz*';
SELECT name FROM sqlite_master WHERE name GLOB 'sqlite_autoindex*';
