...
SELECT substr(t, 1, 1) FROM t1;
SELECT substring('ÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ', 1, 1);
SELECT substr(t, 2, 1) FROM t1;
SELECT substring('ÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ', 2, 1);
SELECT substr(t, 1, 2) FROM t1;
SELECT substring('ÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ', 1, 2);
SELECT substr(t, -1, 1) FROM t1;
SELECT substring('ÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ', -1, 1);
SELECT substr(t, -5, 3) FROM t1;
SELECT substring('aÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´bÃÂÃÂ¢ÃÂÃÂÃÂÃÂcÃÂÃÂ£ÃÂÃÂÃÂÃÂc', -5, 3);
SELECT substr(t, -2, -3) FROM t1;
SELECT substring('aÃÂÃÂ¡ÃÂÃÂÃÂÃÂ´bÃÂÃÂ¢ÃÂÃÂÃÂÃÂcÃÂÃÂ£ÃÂÃÂÃÂÃÂc', -2, -3);
