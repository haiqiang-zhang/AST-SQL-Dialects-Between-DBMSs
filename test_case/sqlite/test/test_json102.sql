...
SELECT json_valid('{"x":-0}'), NOT json_error_position('{"x":-0}');
SELECT json_valid('{"x":0.1}'), NOT json_error_position('{"x":0.1}');
SELECT json_valid('{"x":-0.1}'), NOT json_error_position('{"x":-0.1}');
SELECT json_valid('{"x":0.0000}'), NOT json_error_position('{"x":0.0000}');
SELECT json_valid('{"x":-0.0000}'), NOT json_error_position('{"x":-0.0000}');
SELECT json_valid('{"x":01.5}'), NOT json_error_position('{"x":01.5}');
SELECT json_valid('{"x":-01.5}'), NOT json_error_position('{"x":-01.5}');
SELECT json_valid('{"x":00}'), NOT json_error_position('{"x":00}');
SELECT json_valid('{"x":-00}'), NOT json_error_position('{"x":-00}');
SELECT json_valid('{"x":+0}'), NOT json_error_position('{"x":+0}');
SELECT json_valid('{"x":+5}'), NOT json_error_position('{"x":+5}');
SELECT json_valid('{"x":+5.5}'), NOT json_error_position('{"x":+5.5}');
