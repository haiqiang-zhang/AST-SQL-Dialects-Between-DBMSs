...
INSERT INTO struct_tbl2 VALUES('[{a: 7, b:"Duck"}, {a: 7000, b: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}]');
...
SELECT CAST('[[ [ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ]], [[duck, db, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ], [ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ]], [[ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, duck, db]]]' AS VARCHAR[][][]);
...
SELECT CAST('[''hello'',''world'', ''!'']' AS VARCHAR[]);
SELECT CAST('[''''hello'''',''''world'''', ''''!'''']' AS VARCHAR[]);
SELECT CAST('[[ [''ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ'']], [[duck, db, ''ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ''] ]]' AS VARCHAR[][][]);
...
SELECT CAST('[ [{a:[12,13,14], b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}], [{a:[12,13,14], b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ", c:100}] ]' AS STRUCT(a INT[], b VARCHAR, c FLOAT)[][]);
SELECT CAST('[{a:[12,13,14], b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ", c:{a:[[a], [b, c]], b:[123]}}]' AS STRUCT(a INT[], b VARCHAR, c STRUCT(a VARCHAR[][], b INT[]))[]);
