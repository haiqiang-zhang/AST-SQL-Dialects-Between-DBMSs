...
INSERT INTO try_cast_tbl (VALUES ('{a:{d:1}, b:100, c:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}'), ('{a:{X:1}, b:100, c:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}'), ('{a:{d:1}, b:100, X:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}'), ('{a:"oh oh", b:100, c:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}'), ('{a:{d:"oops"}, b:100, c:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}'), ('{a:{d:"oops"}, b:100, Z: "undercover", c:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}'));
...
INSERT INTO json_tbl2 (VALUES   ('{"A": "Ducky", "B": [3, 50, 8, 43], "C":{"A": "TEST", "B": 0.9, "C": [0.0, 9, 30.2]} }' ), 
                                ('{"A": "TESTY", "B": [4], "C":{"A": "ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ", "B": 6.12, "C": [0.099, 1.6]} }' ),
...
SELECT '{ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ: Quack, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ¤: ....}'::STRUCT(ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ VARCHAR, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ¤ VARCHAR);
...
SELECT '{a:{b:DuckDB, c:{a:{a:0.9, b:{a:"DuckieDuck"}, c:{a:9000}, d:{a:5881580-07-10}}, b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}}, b:900, c:{a:"DuckParty"}}'::STRUCT(a STRUCT(b VARCHAR, c STRUCT(a STRUCT(a FLOAT, b STRUCT(a VARCHAR), c STRUCT(a INT), d STRUCT(a DATE)), b VARCHAR)), b INT, c STRUCT(a VARCHAR));
...
SELECT '{c:{a:"DuckParty"}, b:900, a:{b:DuckDB, c:{a:{a:0.9, b:{a:"DuckieDuck"}, c:{a:9000}, d:{a:5881580-07-10}}, b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ"}}}'::STRUCT(a STRUCT(b VARCHAR, c STRUCT(a STRUCT(a FLOAT, b STRUCT(a VARCHAR), c STRUCT(a INT), d STRUCT(a DATE)), b VARCHAR)), b INT, c STRUCT(a VARCHAR));
...
SELECT '{key_C: {key_B: 3, key_E: ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ}, key_A: 2}'::STRUCT(key_A INT, key_C STRUCT(key_B INT, key_D INT, key_E VARCHAR));
...
SELECT TRY_CAST('{a:4, b:''Ducky'', c:''ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ''}' AS STRUCT(a INT, b DOUBLE, c VARCHAR));
