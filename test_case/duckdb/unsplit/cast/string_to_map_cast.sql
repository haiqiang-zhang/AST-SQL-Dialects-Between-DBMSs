...
INSERT INTO stringMap VALUES ('{1=Duck, 2=DB}'), ('{999=ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ}'), ('{7=Hello, 8=World, 2=!}');
...
INSERT INTO Duck_tbl VALUES ('{1=Duck, 3=DB}'), ('{12=DuckDB}'), ('{3=DB, 5=ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ 4=Ducky, 7=Duckster}'), ('{0=DuckParty}'), ('{5=DBDuck, 7=Duckster, 1=ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ}'), ('{1="final Quack"}');
...
SELECT CAST('{[[''ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ, ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ'']]=100, [[duck, db, ''ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ'']]=101}' AS MAP(VARCHAR[][], INT));
...
SELECT CAST('{A={a:[12,13,14], b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ", c:0.12}, B={a:[12,13,14], b:DuckDuck, c:9.03}}' AS MAP(VARCHAR, STRUCT(a INT[], b VARCHAR, c FLOAT)));
...
SELECT CAST('{{A:AAA}={a:[12,13,14], b:"ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ", c:{a:[[a], [b, c]], b:[123]}}}' AS MAP(STRUCT(A VARCHAR), STRUCT(a INT[], b VARCHAR, c STRUCT(a VARCHAR[][], b INT[]))));
...
SELECT '{ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¦ÃÂÃÂ=ok, duck=happy}'::MAP(VARCHAR, MOOD);
